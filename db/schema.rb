...
ActiveRecord::Schema.define(version: 20140529234421) do
  ...
  add_index "payform_items", ["payform_id"], name: "payform_id", using: :btree
  add_index "payform_items", ["user_id"], name: "user_id", using: :btree
  ...
  add_index "payforms", ["payform_set_id"], name: "payform_set_id", using: :btree
  add_index "payforms", ["user_id"], name: "user_id", using: :btree
  ...
  add_index "report_items", ["report_id"], name: "report_id", using: :btree
  ...
  add_index "reports", ["shift_id"], name: "shift_id", using: :btree
  ...
  add_index "shifts", ["department_id"], name: "department", using: :btree
  add_index "shifts", ["location_id", "late"], name: "loc_stats_late", using: :btree
  add_index "shifts", ["location_id", "left_early"], name: "loc_stats_left_early", using: :btree
  add_index "shifts", ["location_id", "missed"], name: "loc_stats_missed", using: :btree
  add_index "shifts", ["location_id"], name: "location", using: :btree
  add_index "shifts", ["user_id", "late"], name: "stats_late", using: :btree
  add_index "shifts", ["user_id", "left_early"], name: "stats_left_early", using: :btree
  add_index "shifts", ["user_id", "missed"], name: "stats_missed", using: :btree
  add_index "shifts", ["user_id"], name: "index_shifts_on_user_id", using: :btree
  add_index "shifts", ["user_id"], name: "user", using: :btree
  ...
  add_index "sub_requests", ["shift_id"], name: "shift_id", using: :btree
  add_index "sub_requests", ["user_id"], name: "user_id", using: :btree
  ...
  add_index "user_profile_entries", ["user_profile_field_id"], name: "user_profile_field_id", using: :btree
  add_index "user_profile_entries", ["user_profile_id", "user_profile_field_id"], name: "user_profile_id_2", using: :btree
  add_index "user_profile_entries", ["user_profile_id"], name: "user_profile_id", using: :btree
  ...
  add_index "user_profiles", ["user_id"], name: "user_id", using: :btree
